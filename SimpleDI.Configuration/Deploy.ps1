...
Deploy-Package  -SolutionDir 'F:\GPS\SimpleDI.Configuration\SimpleDI.Configuration' `
				-BuildDir 'F:\GPS\SimpleDI.Configuration\SimpleDI.Configuration\GPS.SimpleDI.Configuration\bin\Release' `
				-Namespace "GPS.SimpleDI.Configuration" `
				-Assembly "GPS.SimpleDI.Configuration.dll"